...
namespace deng {
    ...
    void Camera::moveF() {
        this->view_matrix.addToPosition (
            this->m_movement_speed, 
            DENG_COORD_AXIS_Z, 
            false
        );
    }
    ...
    void Camera::setCameraViewRotation() {
        ...
        if(this->m_mouse_pos.first < 2.0f && this->m_mouse_pos.second > -2.0f) 
            ...
            this->m_p_window_wrap->getWindow()->virtual_mouse_position.x = 
            ((this->m_mouse_pos.first - 2.0f) * 
            this->m_mouse_sens.first * 
            this->m_p_window_wrap->getSize().first) / 2;
        }
        ...
        if(this->m_mouse_pos.second <= 1.0f && this->m_mouse_pos.second >= -1.0f)
            ...
            this->m_p_window_wrap->getWindow()->virtual_mouse_position.y = 
            (-this->m_mouse_sens.second * 
            this->m_p_window_wrap->getSize().second) / 2;
