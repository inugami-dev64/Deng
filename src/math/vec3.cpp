...
namespace dengMath {
     ...
     */
    template<typename T>
    deng_bool_t vec3<T>::operator==(const vec3<T> &vec) { 
        return (deng_bool_t) (
            first == vec.first && 
            second == vec.second && 
            third == vec.third
     ...
     */
    template<typename T>
    deng_bool_t vec3<T>::operator==(const das_ObjVertData &vert) {
     ...
     */
    template<typename T>
    deng_bool_t vec3<T>::operator==(const das_ObjNormalData &norm) {
        if(std::is_floating_point<T>::value) {
            return (deng_bool_t) (
                first == norm.nor_x &&
                second == norm.nor_y &&
     ...
     */
    template<typename T>
    deng_bool_t vec3<T>::operator==(const das_ObjVertData2D &vert) {
        if(std::is_floating_point<T>::value || std::is_integral<T>::value) {
            return (deng_bool_t) (
                first == vert.vert_x &&
                second == vert.vert_y
