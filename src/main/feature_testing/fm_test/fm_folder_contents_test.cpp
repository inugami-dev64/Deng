...
int main() {
    ...
    sr.getFolderContents(path, &files_data, DENG_FOLDER_CONTENTS_READ_MODE_RECURSIVE, DENG_FOLDER_CONTENTS_SORT_STYLE_DONT_CARE);
    sr.filterByFileExtension(&files_data, std::string(DENG_FILE_EXTENSION_CSS));
