...
namespace deng {
    ...
    OpenGLApplication::OpenGLApplication() : m_win(1280, 720, DENG_RENDERER_HINT_API_OPENGL, "OpenGL sample") {
        m_cfg.background = dengMath::vec4<deng_vec_t>{0.2f, 0.7f, 0.0f, 1.0f};
        m_cfg.p_win = &m_win;
