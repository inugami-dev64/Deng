...
namespace dengUtils {
    ...
    public:
        ...
        void getFolderContents(const std::string &folder_name, std::vector<std::string> *p_folder_contents, const dengFolderContentsReadMode &folder_contents_read_mode, const dengFolderContentsSortingMode &folder_contents_sort_mode);
        void filterByFileExtension(std::vector<std::string> *p_file_name_data, const std::string &file_extension);
        
        template<typename T>
        T getCSSProperyValue(const std::string &attribute, const std::string &file_path);
    ...
    template<typename T>
    T FileManager::getCSSProperyValue(const std::string &attribute, const std::string &file_path) {
