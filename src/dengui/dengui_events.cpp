...
namespace dengui {
    ...
    deng_bool_t __EH::__EH_UpdateDDMEv (
        ...
        size_t i, j;
        std::array<das_ObjVertData2D, 4> verts;
            ...
            for(j = m_cur_ddm_infos[i].asset_bounds.first; j < m_cur_ddm_infos[i].asset_bounds.second; j++) {
                ...
                if(is_btn) {
                    if(m_cur_ddm_infos[i].asset_bounds.second - m_cur_ddm_infos[i].asset_bounds.first > 1) {
                        verts[0] = (*m_p_assets)[m_cur_ddm_infos[i].asset_bounds.first].vertices.vu2d[0].vert_data;
                        verts[1] = (*m_p_assets)[m_cur_ddm_infos[i].asset_bounds.first].vertices.vu2d[1].vert_data;
                        verts[2] = (*m_p_assets)[m_cur_ddm_infos[i].asset_bounds.second - 2].vertices.vu2d[2].vert_data;
                        verts[3] = (*m_p_assets)[m_cur_ddm_infos[i].asset_bounds.second - 2].vertices.vu2d[3].vert_data;
                    }
                    else {
                        verts[0] = (*m_p_assets)[m_cur_ddm_infos[i].asset_bounds.first].vertices.vu2d[0].vert_data;
                        verts[1] = (*m_p_assets)[m_cur_ddm_infos[i].asset_bounds.first].vertices.vu2d[1].vert_data;
                        verts[2] = (*m_p_assets)[m_cur_ddm_infos[i].asset_bounds.first].vertices.vu2d[2].vert_data;
                        verts[3] = (*m_p_assets)[m_cur_ddm_infos[i].asset_bounds.first].vertices.vu2d[3].vert_data;
                    }
    ...
    void __EH::pushWindowElements (
        ...
        std::vector<das_Asset> tmp_assets(elems.size());
        ...
        for(i = 0, j = elem_offset; i < elems.size(); i++, j++) {
            ...
            tmp_assets[i].uuid = m_win_data[win_i].win_elems[j].asset_id;
            tmp_assets[i].indices.n = m_win_data[win_i].win_elems[j].indices.size();
            tmp_assets[i].indices.indices = m_win_data[win_i].win_elems[j].indices.data();
            ...
            case ELEMENT_COLOR_MODE_TEXTURE_MAPPED: {
                ...
                tmp_img.texture.uuid = m_win_data[win_i].win_elems[j].asset_id;
                ...
                tmp_assets[i].tex_uuid = m_win_data[win_i].win_elems[j].asset_id;
                tmp_assets[i].asset_mode = DAS_ASSET_MODE_2D_TEXTURE_MAPPED;
                tmp_assets[i].vertices.n = m_win_data[win_i].win_elems[j].mapped_vert.size();
                tmp_assets[i].vertices.vm2d = m_win_data[win_i].win_elems[j].mapped_vert.data();
                break;
            }

            case ELEMENT_COLOR_MODE_UNMAPPED:
                tmp_assets[i].asset_mode = DAS_ASSET_MODE_2D_UNMAPPED;
                tmp_assets[i].vertices.n = m_win_data[win_i].win_elems[j].unmapped_vert.size();
                tmp_assets[i].vertices.vu2d = m_win_data[win_i].win_elems[j].unmapped_vert.data();
                break;
    ...
    void __EH::pushCursorDDM (
        ...
        for(size_t i = m_cur_ddm_infos[ddm_index].asset_bounds.first, j = 0; i < m_p_assets->size(); i++, j++) {
            ...
            // Base asset information
            m_p_assets->at(i).uuid = m_cur_ddm_infos[ddm_index].elems[j].asset_id;
            m_p_assets->at(i).is_shown = false;
            m_p_assets->at(i).indices.n = m_cur_ddm_infos[ddm_index].elems[j].indices.size();
            m_p_assets->at(i).indices.indices = m_cur_ddm_infos[ddm_index].elems[j].indices.data();

            // Push vertices to assets vector
            if(m_cur_ddm_infos[ddm_index].elems[j].color_mode == ELEMENT_COLOR_MODE_UNMAPPED) {
                m_p_assets->at(i).asset_mode = DAS_ASSET_MODE_2D_UNMAPPED;
                m_p_assets->at(i).vertices.n = m_cur_ddm_infos[ddm_index].elems[j].unmapped_vert.size();
                m_p_assets->at(i).vertices.vu2d = m_cur_ddm_infos[ddm_index].elems[j].unmapped_vert.data();
                ...
                deng::vulkan::TextureImage tmp_img;
                tmp_img.texture.uuid = m_p_assets->at(i).uuid;
                ...
                m_p_assets->at(i).asset_mode = DAS_ASSET_MODE_2D_TEXTURE_MAPPED;
                m_p_assets->at(i).vertices.n = m_cur_ddm_infos[ddm_index].elems[j].mapped_vert.size();
                m_p_assets->at(i).vertices.vm2d = m_cur_ddm_infos[ddm_index].elems[j].mapped_vert.data();
                m_p_assets->at(i).uuid = m_cur_ddm_infos[ddm_index].elems[j].asset_id;
            }
        }
    ...
    std::vector<das_Asset> *Events::getAssets() {
